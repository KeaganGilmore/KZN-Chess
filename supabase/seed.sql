...
INSERT INTO tournament_media (id, tournament_id, uploaded_by, url, caption, media_type) VALUES
  -- KZN Provincials 2025 photos
  ('m1000000-0000-0000-0000-000000000001', 't1000000-0000-0000-0000-000000000009', 'u1000000-0000-0000-0000-000000000001', 'https://picsum.photos/seed/prov-1/800/600', 'Opening ceremony at the Durban ICC', 'image'),
  ('m1000000-0000-0000-0000-000000000002', 't1000000-0000-0000-0000-000000000009', 'u1000000-0000-0000-0000-000000000002', 'https://picsum.photos/seed/prov-2/800/600', 'Round 1 in progress - packed hall', 'image'),
  ('m1000000-0000-0000-0000-000000000003', 't1000000-0000-0000-0000-000000000009', 'u1000000-0000-0000-0000-000000000005', 'https://picsum.photos/seed/prov-3/800/600', 'Top boards - tense endgame action', 'image'),
  ('m1000000-0000-0000-0000-000000000004', 't1000000-0000-0000-0000-000000000009', 'u1000000-0000-0000-0000-000000000001', 'https://picsum.photos/seed/prov-4/800/600', 'Prize-giving ceremony - our new provincial champion!', 'image'),
  ('m1000000-0000-0000-0000-000000000005', 't1000000-0000-0000-0000-000000000009', 'u1000000-0000-0000-0000-000000000003', 'https://picsum.photos/seed/prov-5/800/600', 'Group photo of all participants', 'image'),
  -- PMB Winter Blitz photos
  ('m1000000-0000-0000-0000-000000000006', 't1000000-0000-0000-0000-000000000010', 'u1000000-0000-0000-0000-000000000003', 'https://picsum.photos/seed/blitz-1/800/600', 'Setting up at the Royal Hotel', 'image'),
  ('m1000000-0000-0000-0000-000000000007', 't1000000-0000-0000-0000-000000000010', 'u1000000-0000-0000-0000-000000000003', 'https://picsum.photos/seed/blitz-2/800/600', 'Blitz action - clocks ticking!', 'image'),
  ('m1000000-0000-0000-0000-000000000008', 't1000000-0000-0000-0000-000000000010', 'u1000000-0000-0000-0000-000000000006', 'https://picsum.photos/seed/blitz-3/800/600', 'The final showdown for first place', 'image'),
  ('m1000000-0000-0000-0000-000000000009', 't1000000-0000-0000-0000-000000000010', 'u1000000-0000-0000-0000-000000000003', 'https://picsum.photos/seed/blitz-4/800/600', 'Winner with trophy and check', 'image'),
  -- Ugu Youth Day photos
  ('m1000000-0000-0000-0000-000000000010', 't1000000-0000-0000-0000-000000000011', 'u1000000-0000-0000-0000-000000000004', 'https://picsum.photos/seed/youth-1/800/600', 'Young players concentrating hard', 'image'),
  ('m1000000-0000-0000-0000-000000000011', 't1000000-0000-0000-0000-000000000011', 'u1000000-0000-0000-0000-000000000004', 'https://picsum.photos/seed/youth-2/800/600', 'Teaching moment - coach helping a beginner', 'image'),
  ('m1000000-0000-0000-0000-000000000012', 't1000000-0000-0000-0000-000000000011', 'u1000000-0000-0000-0000-000000000005', 'https://picsum.photos/seed/youth-3/800/600', 'Medal ceremony for U12 section', 'image'),
  ('m1000000-0000-0000-0000-000000000013', 't1000000-0000-0000-0000-000000000011', 'u1000000-0000-0000-0000-000000000004', 'https://picsum.photos/seed/youth-4/800/600', 'All participants with their certificates', 'image'),
  -- eThekwini Club Championship photos
  ('m1000000-0000-0000-0000-000000000014', 't1000000-0000-0000-0000-000000000012', 'u1000000-0000-0000-0000-000000000002', 'https://picsum.photos/seed/club-1/800/600', 'Round 1 at People''s Park', 'image'),
  ('m1000000-0000-0000-0000-000000000015', 't1000000-0000-0000-0000-000000000012', 'u1000000-0000-0000-0000-000000000002', 'https://picsum.photos/seed/club-2/800/600', 'Outdoor chess with a view of Moses Mabhida', 'image'),
  ('m1000000-0000-0000-0000-000000000016', 't1000000-0000-0000-0000-000000000012', 'u1000000-0000-0000-0000-000000000006', 'https://picsum.photos/seed/club-3/800/600', 'Deciding game of the championship', 'image'),
  -- Poster media for upcoming events
  ('m1000000-0000-0000-0000-000000000017', 't1000000-0000-0000-0000-000000000001', 'u1000000-0000-0000-0000-000000000002', 'https://picsum.photos/seed/durban-poster/800/1100', 'Official tournament poster', 'poster'),
  ('m1000000-0000-0000-0000-000000000018', 't1000000-0000-0000-0000-000000000005', 'u1000000-0000-0000-0000-000000000002', 'https://picsum.photos/seed/zululand-poster/800/1100', 'Zululand Open poster', 'poster')
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO tournament_comments (id, tournament_id, user_id, content, created_at) VALUES
  -- Durban Open comments
  ('c1000000-0000-0000-0000-000000000001', 't1000000-0000-0000-0000-000000000001', 'u1000000-0000-0000-0000-000000000005', 'Can''t wait for this one! Been training all year. See you all there!', '2026-03-01 10:00:00+02'),
  ('c1000000-0000-0000-0000-000000000002', 't1000000-0000-0000-0000-000000000001', 'u1000000-0000-0000-0000-000000000006', 'Is there parking at the ICC? Coming from uMzinyathi district.', '2026-03-02 14:30:00+02'),
  ('c1000000-0000-0000-0000-000000000003', 't1000000-0000-0000-0000-000000000001', 'u1000000-0000-0000-0000-000000000002', 'Yes! There is secure underground parking at the ICC. R30 for the day.', '2026-03-02 15:00:00+02'),
  ('c1000000-0000-0000-0000-000000000004', 't1000000-0000-0000-0000-000000000001', 'u1000000-0000-0000-0000-000000000003', 'Bringing a team from PMB. Looking forward to it!', '2026-03-05 09:15:00+02'),
  -- PMB Rapid comments
  ('c1000000-0000-0000-0000-000000000005', 't1000000-0000-0000-0000-000000000002', 'u1000000-0000-0000-0000-000000000005', 'Love the rapid format. Quick and exciting games!', '2026-03-08 11:00:00+02'),
  ('c1000000-0000-0000-0000-000000000006', 't1000000-0000-0000-0000-000000000002', 'u1000000-0000-0000-0000-000000000006', 'Great venue choice. City Hall has excellent facilities.', '2026-03-10 16:45:00+02'),
  -- Zululand Open comments
  ('c1000000-0000-0000-0000-000000000007', 't1000000-0000-0000-0000-000000000005', 'u1000000-0000-0000-0000-000000000005', 'The Zululand Open is always special. The hospitality is amazing.', '2026-03-15 08:00:00+02'),
  ('c1000000-0000-0000-0000-000000000008', 't1000000-0000-0000-0000-000000000005', 'u1000000-0000-0000-0000-000000000004', 'Any recommendations for accommodation near the venue?', '2026-03-18 12:30:00+02'),
  ('c1000000-0000-0000-0000-000000000009', 't1000000-0000-0000-0000-000000000005', 'u1000000-0000-0000-0000-000000000002', 'Try the Garden Court Ulundi or any of the B&Bs on King Dinuzulu Hwy. All within 5min drive.', '2026-03-18 13:00:00+02'),
  -- Richards Bay Blitz comments
  ('c1000000-0000-0000-0000-000000000010', 't1000000-0000-0000-0000-000000000004', 'u1000000-0000-0000-0000-000000000006', 'Best blitz night in KZN! The pizza makes it even better.', '2026-03-05 20:00:00+02'),
  -- Past tournament comments
  ('c1000000-0000-0000-0000-000000000011', 't1000000-0000-0000-0000-000000000009', 'u1000000-0000-0000-0000-000000000005', 'What an incredible event! Well organized and fierce competition.', '2025-11-17 10:00:00+02'),
  ('c1000000-0000-0000-0000-000000000012', 't1000000-0000-0000-0000-000000000009', 'u1000000-0000-0000-0000-000000000006', 'The level of play was exceptional this year. Already looking forward to 2026!', '2025-11-17 14:00:00+02'),
  ('c1000000-0000-0000-0000-000000000013', 't1000000-0000-0000-0000-000000000009', 'u1000000-0000-0000-0000-000000000001', 'Thank you to all participants and sponsors. Truly a world-class event for KZN chess.', '2025-11-18 09:00:00+02'),
  -- iLembe Beginners comments
  ('c1000000-0000-0000-0000-000000000014', 't1000000-0000-0000-0000-000000000008', 'u1000000-0000-0000-0000-000000000006', 'This is exactly what we need - more beginner-friendly events!', '2026-03-06 11:00:00+02'),
  ('c1000000-0000-0000-0000-000000000015', 't1000000-0000-0000-0000-000000000008', 'u1000000-0000-0000-0000-000000000005', 'Will there be someone teaching the rules from scratch? My kids want to learn.', '2026-03-07 08:30:00+02')
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO tournament_likes (id, tournament_id, user_id) VALUES
  -- Durban Open - very popular
  ('l1000000-0000-0000-0000-000000000001', 't1000000-0000-0000-0000-000000000001', 'u1000000-0000-0000-0000-000000000003'),
  ('l1000000-0000-0000-0000-000000000002', 't1000000-0000-0000-0000-000000000001', 'u1000000-0000-0000-0000-000000000004'),
  ('l1000000-0000-0000-0000-000000000003', 't1000000-0000-0000-0000-000000000001', 'u1000000-0000-0000-0000-000000000005'),
  ('l1000000-0000-0000-0000-000000000004', 't1000000-0000-0000-0000-000000000001', 'u1000000-0000-0000-0000-000000000006'),
  -- PMB Rapid
  ('l1000000-0000-0000-0000-000000000005', 't1000000-0000-0000-0000-000000000002', 'u1000000-0000-0000-0000-000000000005'),
  ('l1000000-0000-0000-0000-000000000006', 't1000000-0000-0000-0000-000000000002', 'u1000000-0000-0000-0000-000000000006'),
  ('l1000000-0000-0000-0000-000000000007', 't1000000-0000-0000-0000-000000000002', 'u1000000-0000-0000-0000-000000000004'),
  -- Zululand Open
  ('l1000000-0000-0000-0000-000000000008', 't1000000-0000-0000-0000-000000000005', 'u1000000-0000-0000-0000-000000000005'),
  ('l1000000-0000-0000-0000-000000000009', 't1000000-0000-0000-0000-000000000005', 'u1000000-0000-0000-0000-000000000003'),
  ('l1000000-0000-0000-0000-000000000010', 't1000000-0000-0000-0000-000000000005', 'u1000000-0000-0000-0000-000000000004'),
  -- Richards Bay Blitz
  ('l1000000-0000-0000-0000-000000000011', 't1000000-0000-0000-0000-000000000004', 'u1000000-0000-0000-0000-000000000006'),
  ('l1000000-0000-0000-0000-000000000012', 't1000000-0000-0000-0000-000000000004', 'u1000000-0000-0000-0000-000000000005'),
  -- KZN Provincials 2025 - most liked
  ('l1000000-0000-0000-0000-000000000013', 't1000000-0000-0000-0000-000000000009', 'u1000000-0000-0000-0000-000000000002'),
  ('l1000000-0000-0000-0000-000000000014', 't1000000-0000-0000-0000-000000000009', 'u1000000-0000-0000-0000-000000000003'),
  ('l1000000-0000-0000-0000-000000000015', 't1000000-0000-0000-0000-000000000009', 'u1000000-0000-0000-0000-000000000004'),
  ('l1000000-0000-0000-0000-000000000016', 't1000000-0000-0000-0000-000000000009', 'u1000000-0000-0000-0000-000000000005'),
  ('l1000000-0000-0000-0000-000000000017', 't1000000-0000-0000-0000-000000000009', 'u1000000-0000-0000-0000-000000000006'),
  -- South Coast Juniors
  ('l1000000-0000-0000-0000-000000000018', 't1000000-0000-0000-0000-000000000003', 'u1000000-0000-0000-0000-000000000004'),
  ('l1000000-0000-0000-0000-000000000019', 't1000000-0000-0000-0000-000000000003', 'u1000000-0000-0000-0000-000000000005'),
  -- iLembe Beginners
  ('l1000000-0000-0000-0000-000000000020', 't1000000-0000-0000-0000-000000000008', 'u1000000-0000-0000-0000-000000000005'),
  ('l1000000-0000-0000-0000-000000000021', 't1000000-0000-0000-0000-000000000008', 'u1000000-0000-0000-0000-000000000006')
ON CONFLICT (id) DO NOTHING;
